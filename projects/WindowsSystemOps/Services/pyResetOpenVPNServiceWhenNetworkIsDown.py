...
def renew_and_update_conn():
    ...
    os.system('ipconfig /renew "以太网 3"'.encode('gbk'))  # "以太网 3" is OpenVPN connection name
...
def reset_network_interface_card():
    ...
    :return:
    """
    os.system('netsh interface show interface "以太网 3"'.encode('gbk'))
    os.system('netsh interface set interface name="以太网 3" admin=DISABLED'.encode('gbk'))
    time.sleep(1)
    os.system('netsh interface set interface name="以太网 3" admin=ENABLED'.encode('gbk'))
    os.system('netsh interface show interface "以太网 3"'.encode('gbk'))
