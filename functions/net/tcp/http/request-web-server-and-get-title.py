...
def request_ip_port_80(ip):
    ...
    if response.ok:
        ...
        # print("{} : {}".format(ip, get_title_from_html(str(response.content, "utf-8"))))
        print("{} : {}".format(ip, get_title_from_html(response.content.decode("utf-8"))))

        # response.text    type: str
        print("{} : {}".format(ip, get_title_from_html(response.text.encode(response.encoding).decode("utf-8"))))
